import {
	...
	Vector2,
	Vector3
} from "../gallery/js/three.module.js";
...
// this method is exposed, but perhaps it would be better if we can make it private...
  ...
  function rotateUp( angle ) {
    sphericalDelta.phi -= angle;//rota de arriba abajo
  }
  ...
  var pan = function () {
    ...
    return function pan( deltaX, deltaY ) {
      ...
      if ( scope.object.isPerspectiveCamera ) {
        ...
        panLeft( 
	  2 * deltaX * targetDistance / element.clientHeight, scope.object.matrix 
	);
        panUp( 
	  2 * deltaY * targetDistance / element.clientHeight, scope.object.matrix 
	);
